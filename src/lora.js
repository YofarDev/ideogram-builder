...
const LORAS = [
  ...
  },
  {
    id: 'tintin-v1-5k',
    label: 'Tintin (5k)',
    filename: 'tintin_lora_v1_000005000.safetensors',
    source_url: 'https://huggingface.co/Yofardev/tintin_ideogram4_v1/resolve/main/tintin_lora_v1_000005000.safetensors',
    strengths: { positive: 1.0, unconditional: 0.5 },
    overrides: {},
  },
  {
  ...
  },
  {
    id: 'tintin-v1-8k',
    label: 'Tintin (8k)',
    filename: 'tintin_lora_v1_000008000.safetensors',
    source_url: 'https://huggingface.co/Yofardev/tintin_ideogram4_v1/resolve/main/tintin_lora_v1_000008000.safetensors',
    strengths: { positive: 1.0, unconditional: 0.5 },
    overrides: {},
  },
  {
    id: 'tintin-v1-9k',
    label: 'Tintin (9k)',
    filename: 'tintin_lora_v1_000009000.safetensors',
    source_url: 'https://huggingface.co/Yofardev/tintin_ideogram4_v1/resolve/main/tintin_lora_v1_000009000.safetensors',
    strengths: { positive: 1.0, unconditional: 0.5 },
    overrides: {},
  },
  {
    id: 'tintin-v1-10k',
    label: 'Tintin (10k)',
    filename: 'tintin_lora_v1.safetensors',
    source_url: 'https://huggingface.co/Yofardev/tintin_ideogram4_v1/resolve/main/tintin_lora_v1.safetensors',
    strengths: { positive: 1.0, unconditional: 0.5 },
    overrides: {},
  },
];
